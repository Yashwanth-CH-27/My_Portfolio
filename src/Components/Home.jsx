...
const Home = () => {
  ...
  return (
    <div id="home" className="w-screen mt-[35%] md:mt-[5%] mx-5 md:mx-45 flex flex-col md:flex-row gap-10 md:gap-50 items-center scroll-m-30 h-screen">
      ...
      <div>
        <div className="">
          ...
          <div className="my-7">
            <a
              href="/Portfolio/public/Yaswanth_Sai_Kiran_Chundru_Resume.pdf"
